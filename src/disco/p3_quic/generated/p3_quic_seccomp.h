...
#ifndef HEADER_fd_src_disco_p3_quic_generated_p3_quic_seccomp_h
#define HEADER_fd_src_disco_p3_quic_generated_p3_quic_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_p3_quic_instr_cnt = 15;

static void populate_sock_filter_policy_p3_quic( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 15 );
