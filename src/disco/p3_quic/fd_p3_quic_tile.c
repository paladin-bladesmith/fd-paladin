...
populate_allowed_seccomp( fd_topo_t const *      topo,
  ...
  populate_sock_filter_policy_p3_quic( out_cnt, out, (uint)fd_log_private_logfile_fd() );
  return sock_filter_policy_p3_quic_instr_cnt;
}
